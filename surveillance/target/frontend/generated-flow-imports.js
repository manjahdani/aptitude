...
import $css_0 from 'Frontend/styles/views/video/video-view.css';
addCssBlock(`<custom-style><style>${$css_0}</style></custom-style>`);
import $css_1 from 'Frontend/styles/views/helloworld/hello-world-view.css';
addCssBlock(`<custom-style><style>${$css_1}</style></custom-style>`);
import $css_2 from 'Frontend/styles/views/about/about-view.css';
