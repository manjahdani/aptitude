...
import be.uclouvain.aptitude.surveillance.ui.DeviceNetworkManagerSkill;
import be.uclouvain.aptitude.surveillance.ui.MobileOutputSkill;
...
public class UserInterface extends Paraddis {
  protected OpenEventSpace TOLDInteractivitySpace;
  ...
  @SyntheticMember
  public UserInterface(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public UserInterface(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public UserInterface(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
