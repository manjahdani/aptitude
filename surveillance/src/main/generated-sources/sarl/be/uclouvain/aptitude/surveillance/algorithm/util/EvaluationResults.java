...
public class EvaluationResults {
  ...
  public EvaluationResults(final UUID id, final String s, final double ts, final double tt, final int f) {
  ...
  public EvaluationResults(final UUID id, final String s, final double ts, final double tt) {
    this.CompetitorID = id;
    this.CompetitorBelief = s;
    this.DetectionTime = ts;
    this.TrackingTime = tt;
